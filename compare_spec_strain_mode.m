...
interpol_vals    = interpolate_values(reshaped_proc_data);
interpol_vals_np = interpolate_values(reshaped_proc_data_np);
...
title(['Mode ', num2str(modes_index)])
hold on
...
plot(interpol_vals.freq_vals(mode_index,:),abs(100*(nz_val-zer_val)/zer_val) ,'-x','color',cc(line_number,:))
...
plot(interpol_vals_np.freq_vals(mode_index,:),abs(100*(nz_val-zer_val)/zer_val) ,'-x','color',cc(line_number,:))    
if line_number == no_to_plot
comma_insert = '';
else
comma_insert = ',';
...
plot(interpol_vals.freq_vals_np(mode_index,:),abs(100*(nz_val-zer_val)/zer_val) ,'-x','color',cc(line_number,:))    
...
function interpol_vals =   interpolate_values(reshaped_proc_data);
